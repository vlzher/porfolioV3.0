    ...
    <div class="project-head">
      ...
      <div class="project-hover" style="top: 100%;">
        <div class="project-body text-center">
          ...
          <ul class="filters filters-tag text-center" :style="{marginTop: '10px'}" @click="e => filterClick(e)">
            tech:
            <li :style="{marginTop: '5px'}" v-for="tag in tags" ><a>{{ tag }}</a></li>
          </ul>

          <div class="btn-group" role="group">
            <a :href="codeURL"  class="btn  project-btn"><i class="fas fa-code"></i> Code</a>
            <a :href="viewURL" :class="isDisabled ? 'disabled' : ''" class="btn  project-btn"><i class="far fa-eye"></i> View</a>
          </div>
        </div>
      </div>
    </div>
